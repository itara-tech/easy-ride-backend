/*
  ...
  - You are about to drop the column `userType` on the `OTP` table. All the data in the column will be lost.
  - You are about to drop the column `userId` on the `PasswordReset` table. All the data in the column will be lost.
  - You are about to drop the column `userType` on the `PasswordReset` table. All the data in the column will be lost.
