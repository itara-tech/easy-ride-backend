...
export async function getNearestRouteDistanceRoutesAPI(
  originCoords,
  destinationCoords,
  travelMode = 'DRIVE',
  unitSystem = 'METRIC',
  ...
  console.log(
    `Requesting distance from ${originCoords.lat}, ${originCoords.lon} to ${destinationCoords.lat}, ${destinationCoords.lon}`,
  );
  const apiKey = process.env.GOOGLE_MAPS_API_KEY;
